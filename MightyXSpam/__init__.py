...
async def MightyX():
    ...
    if STRING3:
        ...
        try:
            ...
            await  Mig3.start()
            await Mig3(functions.channels.JoinChannelRequest(channel="@SOUL_ARMY_0P"))
            await Mig3(functions.channels.JoinChannelRequest(channel="@SOUL_ARMY_0P"))
    ...
    if STRING4:
        ...
        try:
            ...
            await Mig4.start()
            await Mig4(functions.channels.JoinChannelRequest(channel="@SOUL_ARMY_0P"))
            await Mig4(functions.channels.JoinChannelRequest(channel="@SOUL_ARMY_0P"))
    ...
    if STRING5:
        ...
        try:
            ...
            await Mig5.start()
            await Mig5(functions.channels.JoinChannelRequest(channel="@SOUL_ARMY_0P"))
            await Mig5(functions.channels.JoinChannelRequest(channel="@SOUL_ARMY_0P"))
    ...
    if STRING6:
        ...
        try:
            ...
            await Mig6.start()
            await Mig6(functions.channels.JoinChannelRequest(channel="@SOUL_ARMY_0P"))
            await Mig6(functions.channels.JoinChannelRequest(channel="@SOUL_ARMY_0P"))
    ...
    if STRING7:
        ...
        try:
            ...
            await Mig7.start()
            await Mig7(functions.channels.JoinChannelRequest(channel="@SOUL_ARMY_0P"))
            await Mig7(functions.channels.JoinChannelRequest(channel="@SOUL_ARMY_0P"))
    ...
    if STRING8:
        ...
        try:
            ...
            await Mig8.start()
            await Mig8(functions.channels.JoinChannelRequest(channel="@SOUL_ARMY_0P"))
            await Mig8(functions.channels.JoinChannelRequest(channel="@SOUL_ARMY_0P"))
    ...
    if STRING9:
        ...
        try:
            ...
            await Mig9.start()
            await Mig9(functions.channels.JoinChannelRequest(channel="@SOUL_ARMY_0P"))
            await Mig9(functions.channels.JoinChannelRequest(channel="@SOUL_ARMY_0P"))
    ...
    if STRING10:
        ...
        try:
            ...
            await Mig10.start()
            await Mig10(functions.channels.JoinChannelRequest(channel="@SOUL_ARMY_0P"))
            await Mig10(functions.channels.JoinChannelRequest(channel="@SOUL_ARMY_0P"))
    ...
    if STRING11:
        ...
        try:
            ...
            await Mig11.start()
            await Mig11(functions.channels.JoinChannelRequest(channel="@SOUL_ARMY_0P"))
            await Mig11(functions.channels.JoinChannelRequest(channel="@SOUL_ARMY_0P"))
    ...
    if STRING12:
        ...
        try:
            ...
            await Mig12.start()
            await Mig12(functions.channels.JoinChannelRequest(channel="@SOUL_ARMY_0P"))
            await Mig12(functions.channels.JoinChannelRequest(channel="@SOUL_ARMY_0P"))
    ...
    if STRING13:
        ...
        try:
            ...
            await Mig13.start()
            await Mig13(functions.channels.JoinChannelRequest(channel="@SOUL_ARMY_0P"))
            await Mig13(functions.channels.JoinChannelRequest(channel="@SOUL_ARMY_0P"))
    ...
    if STRING14:
        ...
        try:
            ...
            await Mig14.start()
            await Mig14(functions.channels.JoinChannelRequest(channel="@SOUL_ARMY_0P"))
            await Mig14(functions.channels.JoinChannelRequest(channel="@SOUL_ARMY_0P"))
    ...
    if STRING15:
        ...
        try:
            ...
            await Mig15.start()
            await Mig15(functions.channels.JoinChannelRequest(channel="@SOUL_ARMY_0P"))
            await Mig15(functions.channels.JoinChannelRequest(channel="@SOUL_ARMY_0P"))
    ...
    if STRING16:
        ...
        try:
            ...
            await Mig16(functions.channels.JoinChannelRequest(channel="@SOUL_ARMY_0P"))
            await Mig16(functions.channels.JoinChannelRequest(channel="@SOUL_ARMY_0P"))
            botid = telethon.utils.get_peer_id(botme)
            SUDO_USERS.append(botid)
        except Exception as e:
    ...
    if STRING17:
        ...
        try:
            ...
            await Mig17(functions.channels.JoinChannelRequest(channel="@SOUL_ARMY_0P"))
            await Mig17(functions.channels.JoinChannelRequest(channel="@SOUL_ARMY_0P"))
            botid = telethon.utils.get_peer_id(botme)
            SUDO_USERS.append(botid)
        except Exception as e:
    ...
    if STRING18:
        ...
        try:
            ...
            await Mig18(functions.channels.JoinChannelRequest(channel="@SOUL_ARMY_0P"))
            await Mig18(functions.channels.JoinChannelRequest(channel="@SOUL_ARMY_0P"))
            botid = telethon.utils.get_peer_id(botme)
            SUDO_USERS.append(botid)
        except Exception as e:
    ...
    if STRING19:
        ...
        try:
            ...
            await Mig19(functions.channels.JoinChannelRequest(channel="@SOUL_ARMY_0P"))
            await Mig19(functions.channels.JoinChannelRequest(channel="@SOUL_ARMY_0P"))
            botid = telethon.utils.get_peer_id(botme)
            SUDO_USERS.append(botid)
        except Exception as e:
    ...
    if STRING20:
        ...
        try:
            ...
            await Mig20(functions.channels.JoinChannelRequest(channel="@SOUL_ARMY_0P"))
            await Mig20(functions.channels.JoinChannelRequest(channel="@SOUL_ARMY_0P"))
            botid = telethon.utils.get_peer_id(botme)
            SUDO_USERS.append(botid)
        except Exception as e:
    ...
    if STRING21:
        ...
        try:
            ...
            await Mig21(functions.channels.JoinChannelRequest(channel="@SOUL_ARMY_0P"))
            await Mig21(functions.channels.JoinChannelRequest(channel="@SOUL_ARMY_0P"))
            botid = telethon.utils.get_peer_id(botme)
            SUDO_USERS.append(botid)
        except Exception as e:
    ...
    if STRING22:
        ...
        try:
            ...
            await Mig22.start()
            await Mig22(functions.channels.JoinChannelRequest(channel="@SOUL_ARMY_0P"))
            await Mig22(functions.channels.JoinChannelRequest(channel="@SOUL_ARMY_0P"))
    ...
    if STRING23:
        ...
        try:
            ...
            await  Mig23.start()
            await Mig23(functions.channels.JoinChannelRequest(channel="@SOUL_ARMY_0P"))
            await Mig23(functions.channels.JoinChannelRequest(channel="@SOUL_ARMY_0P"))
    ...
    if STRING24:
        ...
        try:
            ...
            await Mig24.start()
            await Mig24(functions.channels.JoinChannelRequest(channel="@SOUL_ARMY_0P"))
            await Mig24(functions.channels.JoinChannelRequest(channel="@SOUL_ARMY_0P"))
    ...
    if STRING25:
        ...
        try:
            ...
            await Mig25.start()
            await Mig25(functions.channels.JoinChannelRequest(channel="@SOUL_ARMY_0P"))
            await Mig25(functions.channels.JoinChannelRequest(channel="@SOUL_ARMY_0P"))
    ...
    if STRING26:
        ...
        try:
            ...
            await Mig26.start()
            await Mig26(functions.channels.JoinChannelRequest(channel="@SOUL_ARMY_0P"))
            await Mig26(functions.channels.JoinChannelRequest(channel="@SOUL_ARMY_0P"))
    ...
    if STRING27:
        ...
        try:
            ...
            await Mig27.start()
            await Mig27(functions.channels.JoinChannelRequest(channel="@SOUL_ARMY_0P"))
            await Mig27(functions.channels.JoinChannelRequest(channel="@SOUL_ARMY_0P"))
    ...
    if STRING28:
        ...
        try:
            print("Booting Up The Client 18")
            await Mig28.start()
            await Mig28(functions.channels.JoinChannelRequest(channel="@SOUL_ARMY_0P"))
            await Mig28(functions.channels.JoinChannelRequest(channel="@SOUL_ARMY_0P"))
    ...
    if STRING29:
        ...
        try:
            ...
            await Mig29.start()
            await Mig29(functions.channels.JoinChannelRequest(channel="@SOUL_ARMY_0P"))
            await Mig29(functions.channels.JoinChannelRequest(channel="@SOUL_ARMY_0P"))
    ...
    if STRING30:
        ...
        try:
            ...
            await Mig30.start()
            await Mig30(functions.channels.JoinChannelRequest(channel="@SOUL_ARMY_0P"))
            await Mig30(functions.channels.JoinChannelRequest(channel="@SOUL_ARMY_0P"))
    ...
    if STRING31:
        ...
        try:
            ...
            await Mig31.start()
            await Mig31(functions.channels.JoinChannelRequest(channel="@SOUL_ARMY_0P"))
            await Mig31(functions.channels.JoinChannelRequest(channel="@SOUL_ARMY_0P"))
    ...
    if STRING32:
        ...
        try:
            print("Booting Up The Client 32")
            await Mig32.start()
            await Mig32(functions.channels.JoinChannelRequest(channel="@SOUL_ARMY_0P"))
            await Mig32(functions.channels.JoinChannelRequest(channel="@SOUL_ARMY_0P"))
    ...
    if STRING33:
        ...
        try:
            ...
            await Mig33.start()
            await Mig33(functions.channels.JoinChannelRequest(channel="@SOUL_ARMY_0P"))
            await Mig33(functions.channels.JoinChannelRequest(channel="@SOUL_ARMY_0P"))
    ...
    if STRING34:
        ...
        try:
            ...
            await Mig34.start()
            await Mig34(functions.channels.JoinChannelRequest(channel="@SOUL_ARMY_0P"))
            await Mig34(functions.channels.JoinChannelRequest(channel="@SOUL_ARMY_0P"))
    ...
    if STRING35:
        ...
        try:
            print("Booting Up The Client 35")
            await Mig35.start()
            await Mig35(functions.channels.JoinChannelRequest(channel="@SOUL_ARMY_0P"))
            await Mig35(functions.channels.JoinChannelRequest(channel="@SOUL_ARMY_0P"))
    ...
    if STRING36:
        ...
        try:
            ...
            await Mig36(functions.channels.JoinChannelRequest(channel="@SOUL_ARMY_0P"))
            await Mig36(functions.channels.JoinChannelRequest(channel="@SOUL_ARMY_0P"))
            botid = telethon.utils.get_peer_id(botme)
            SUDO_USERS.append(botid)
        except Exception as e:
    ...
    if STRING37:
        ...
        try:
            ...
            await Mig37(functions.channels.JoinChannelRequest(channel="@SOUL_ARMY_0P"))
            await Mig37(functions.channels.JoinChannelRequest(channel="@SOUL_ARMY_0P"))
            botid = telethon.utils.get_peer_id(botme)
            SUDO_USERS.append(botid)
        except Exception as e:
    ...
    if STRING38:
        ...
        try:
            ...
            await Mig38(functions.channels.JoinChannelRequest(channel="@SOUL_ARMY_0P"))
            await Mig38(functions.channels.JoinChannelRequest(channel="@SOUL_ARMY_0P"))
            botid = telethon.utils.get_peer_id(botme)
            SUDO_USERS.append(botid)
        except Exception as e:
    ...
    if STRING39:
        ...
        try:
            ...
            await Mig39(functions.channels.JoinChannelRequest(channel="@SOUL_ARMY_0P"))
            await Mig39(functions.channels.JoinChannelRequest(channel="@SOUL_ARMY_0P"))
            botid = telethon.utils.get_peer_id(botme)
            SUDO_USERS.append(botid)
        except Exception as e:
    ...
    if STRING40:
        ...
        try:
            ...
            await Mig40(functions.channels.JoinChannelRequest(channel="@SOUL_ARMY_0P"))
            await Mig40(functions.channels.JoinChannelRequest(channel="@SOUL_ARMY_0P"))
            botid = telethon.utils.get_peer_id(botme)
            SUDO_USERS.append(botid)
        except Exception as e:
